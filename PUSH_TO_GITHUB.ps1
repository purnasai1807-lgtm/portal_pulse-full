...
Write-Host "`n[2/4] Creating GitHub repo 'PortalPulse'..." -ForegroundColor Yellow
...
if ($remoteUrl -match "purnasai1807-Igtm/PortalPulse") {
    Write-Host "SUCCESS! Repo pushed to:" -ForegroundColor Green
    Write-Host "https://github.com/purnasai1807-Igtm/PortalPulse" -ForegroundColor Cyan
} else {
...
Write-Host "https://render.com/deploy?repo=https://github.com/purnasai1807-Igtm/PortalPulse" -ForegroundColor Cyan
